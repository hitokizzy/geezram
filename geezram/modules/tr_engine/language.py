...
from geezram.modules.sql.locales_sql import switch_to_locale, prev_locale
from geezram.modules.tr_engine.strings import tld, LANGUAGES
from geezram.modules.tr_engine.list_locale import list_locales
